	...
	_createClass(Calculator, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(Grid, { onClick: function onClick(i) {
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'row' },
					_react2.default.createElement(Button, { value: 'AC', classVal: 'top-op', onClick: this.props.clearClick }),
					_react2.default.createElement(Button, { value: 'C', classVal: 'top-op', onClick: this.props.clearCurrentClick }),
					_react2.default.createElement(Button, { value: '+/-', classVal: 'top-op', onClick: this.props.changeSign }),
					this.renderOpButton('/')
				),
				_react2.default.createElement(
					'div',
