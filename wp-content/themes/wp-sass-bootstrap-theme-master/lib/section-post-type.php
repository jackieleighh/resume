...
function section_post() {
	...
	$labels = array(
		'name'                  => _x( 'Section Posts', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Section Post', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Sections', 'text_domain' ),
		'name_admin_bar'        => __( 'Sections', 'text_domain' ),
		'archives'              => __( 'Sections Archive', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Sections', 'text_domain' ),
		'add_new_item'          => __( 'Add Section', 'text_domain' ),
		'add_new'               => __( 'Add Section', 'text_domain' ),
		'new_item'              => __( 'New Section', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'sections', 'text_domain' ),
		'description'           => __( 'Section Content', 'text_domain' ),
		'labels'                => $labels,
...
add_action( 'init', 'section_post', 0 );
?>