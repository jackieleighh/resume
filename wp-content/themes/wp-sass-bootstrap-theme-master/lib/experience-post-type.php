...
function experience_post() {

	$labels = array(
		'name'                  => _x( 'Experience Posts', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Experience Post', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Experience', 'text_domain' ),
		'name_admin_bar'        => __( 'Experience', 'text_domain' ),
		'archives'              => __( 'Experience Archive', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'Experience Content', 'text_domain' ),
		'labels'                => $labels,
...
add_action( 'init', 'experience_post', 0 );
?>