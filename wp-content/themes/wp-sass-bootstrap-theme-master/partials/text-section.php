...
<div class="parallax_layer">
    <section id="<?php echo get_the_title(); ?>" class="layer" <?php if($background_image): ?> style="background-image: url('<?php echo $background_image;?>');" <?php else: ?> style="background-color: <?php echo $background_color; ?>" <?php endif; ?>>
